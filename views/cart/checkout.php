            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <?php if ($result): ?>
                        ...
                        <p>Заказ оформлен. Ожидайте.</p>
                        
                        <br><br>
                        <h2>Ваш заказ номер - <?php echo Cart::getNumber($id);?></h2>

                    <?php else: ?>
                           
                        <p>Выбрано блюд: <?php echo $totalQuantity; ?>, 
                            <br>на сумму: <?php echo $totalPrice; ?> грн.</p><br/>
