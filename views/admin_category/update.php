            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <img src="<?php echo Category::getCategoryImage($category['id']); ?>" width="200" alt="" /><br><br>
                        <input type="file" name="image" placeholder="" value="<?php if(isset($category['image']))echo $category['image']; ?>">
